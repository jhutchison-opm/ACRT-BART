import{c as s,r as n,m as o}from"./render-template.EPiOIgNG.js";import{u as r}from"./input-form.fiE94tlJ.js";import"./jsx-runtime.G4i-1Giy.js";import"./index.UCAuQZPX.js";const t=`<h2 id="developer-updatesnotes">Developer Updates/Notes</h2>
<ul>
...
</ul>`,l={title:"Create Report"},a="C:/Users/JRHUTCHISON/OneDrive - US Office of Personnel Management/Documents/GitHub/ACRT-BART/src/content/pages/create-report.md",i="/create-report";function g(){return`## Developer Updates/Notes\r
\r
...
`}function A(){return t}function C(){return[{depth:2,slug:"developer-updatesnotes",text:"Developer Updates/Notes"},{depth:2,slug:"bart-app-instructions",text:"BART App Instructions"}]}const R=s((d,c,p)=>{const{layout:u,...e}=l;return e.file=a,e.url=i,n`${o()}${r(t)}`});export{R as Content,A as compiledContent,R as default,a as file,l as frontmatter,C as getHeadings,g as rawContent,i as url};
