import{c as s,r as n,m as o}from"./render-template.Q3Z-mWLO.js";import{u as r}from"./input-form.KzPZa9ro.js";import"./jsx-runtime.G4i-1Giy.js";import"./index.UCAuQZPX.js";const t=`<h2 id="developer-updatesnotes">Developer Updates/Notes</h2>
<ul>
...
</ul>`,l={title:"Create Report"},a="C:/Users/JRHUTCHISON/OneDrive - US Office of Personnel Management/Documents/GitHub/ACRT-BART/src/content/pages/create-report.md",i="/ACRT-BART/create-report";function g(){return`## Developer Updates/Notes\r
\r
...
`}function A(){return t}function R(){return[{depth:2,slug:"developer-updatesnotes",text:"Developer Updates/Notes"},{depth:2,slug:"bart-app-instructions",text:"BART App Instructions"}]}const C=s((d,c,p)=>{const{layout:u,...e}=l;return e.file=a,e.url=i,n`${o()}${r(t)}`});export{C as Content,A as compiledContent,C as default,a as file,l as frontmatter,R as getHeadings,g as rawContent,i as url};
