import{c as s,r as n,m as o}from"./render-template.PcwmmXua.js";import{u as r}from"./input-form.PFPFGb1k.js";import"./index.UCAuQZPX.js";const t=`<h2 id="developer-updatesnotes">Developer Updates/Notes</h2>
<ul>
...
</ul>`,l={title:"Create Report"},a="C:/Users/JRHUTCHISON/OneDrive - US Office of Personnel Management/Documents/GitHub/ACRT-BART/src/content/pages/create-report.md",i="/create-report";function T(){return`## Developer Updates/Notes\r
\r
...
`}function g(){return t}function A(){return[{depth:2,slug:"developer-updatesnotes",text:"Developer Updates/Notes"},{depth:2,slug:"bart-app-instructions",text:"BART App Instructions"}]}const C=s((d,c,p)=>{const{layout:u,...e}=l;return e.file=a,e.url=i,n`${o()}${r(t)}`});export{C as Content,g as compiledContent,C as default,a as file,l as frontmatter,A as getHeadings,T as rawContent,i as url};
