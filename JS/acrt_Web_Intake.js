const app = angular.module("acrtWebIntake", []);

// Alert message before navigating away from page

window.onbeforeunload = function (event) {
  const message = "Are you Sure you want to leave Create Report Page ?";
  ...
  function () {
    return {
      ...
      link: function (scope, elem, attrs) {
        const limit = parseInt(attrs.limitTo);
...
function show_hide_column(col_no, do_show) {
  const rows = document.getElementById("rmdTble").rows;
...
app.controller("acrtWebIntakeCtrl", [
  "$scope",
...
*/
    ...
    "Notes": '' + $scope.jsonData[0].Criteria[addedPosition].Notes + '',
	  ...
	  */
            ...
            $scope.jsonData[0].Criteria.splice(
              addedPosition,
              0,
              $scope.Mul_Issues1[addedPosition],
            );
            ...
            if ($scope.indexCollection.length > 0) {
              for (let n = $scope.indexCollection.length; n > 0; n--) {
                const posLoc = $scope.origSelectedResults - n;
                const posNew = $scope.origSelectedResults - n + 1;
                const posShift = $scope.parentIssueSelected + n;
		...
		*/
                ...
                $scope.Guideline[posNew] =
                  $scope.jsonData[0].Criteria[posLoc].Guideline;
                $scope.TestResult[posNew] =
                  $scope.jsonData[0].Criteria[posLoc].TestResult;
                // BART
                $scope.TestProcess[posNew] =
                  $scope.jsonData[0].Criteria[posLoc].TestProcess;
                $scope.TesterComment[posNew] =
                  $scope.jsonData[0].Criteria[posLoc].TesterComment;
                $scope.location[posNew] =
                  $scope.jsonData[0].Criteria[posLoc].location;
                $scope.ImageSrc[posNew] =
                  $scope.jsonData[0].Criteria[posLoc].ImageSrc;
                $scope.RemediationDetails[posNew] =
                  $scope.jsonData[0].Criteria[posLoc].RemediationDetails;
                $scope.ImageSrc2[posNew] =
                  $scope.jsonData[0].Criteria[posLoc].ImageSrc2;
                $scope.RemediationDate[posNew] =
                  $scope.jsonData[0].Criteria[posLoc].RemediationDate;
              }
            }
	    ...
	    "InsrtIndex": '"'+ $scope.parentIssueSelected + '', */
              InsrtTestID:
                "" +
                $scope.jsonData[0].Criteria[$scope.parentIssueSelected].TestID +
                "",
              InsrtDisabilityImpact:
                "" +
                $scope.jsonData[0].Criteria[$scope.parentIssueSelected]
                  .DisabilityImpact +
                "",
              InsrtGuideline:
                "" +
	...
	alert('Please select Test result for this test before adding new one.');
          ...
          $scope.removeIssue = function (index) {
            const removePosition = index + $scope.origSelectedResults;
            // if ($scope.checkboxModel.alerts == "on")
            // alert('Issue Removed.');
          ...
          if ($scope.jsonData[0].System.S_Compatibility != undefined) {
            $scope.default_compatibilitySetting =
              $scope.jsonData[0].System.S_Compatibility;
          }
          ...
          if ($scope.jsonData[0].Submitter.T_evalMthd_Vrsn != undefined) {
            $scope.default_tstVrsn =
              $scope.jsonData[0].Submitter.T_evalMthd_Vrsn;
          }
          ...
          $scope.jsonData[0].System.S_other =
            $scope.jsonData[0].System.S_other.toString().trim();
          if (
            $scope.jsonData[0].System.S_other === "Other Browser" ||
            $scope.jsonData[0].System.S_other === "  Other Browser  "
          ) {
          ...
          if ($scope.jsonData[0].System.S_otherOSChked != "undefined") {
            $scope.chkBoxValOthrWndw1 =
              $scope.jsonData[0].System.S_otherOSChked;
          ...
          $scope.criteriaResultOriginal = $scope.criteriaResultOriginal.filter(
            $scope.onlyUnique,
          );
          $scope.rmdatnDtlID = [];
		  ...
		  if ($scope.selected_name_tstgrp[b] == 'undefined') {
            ...
            // $scope.menu1[b] = $scope.jsonData[0].Criteria[b].OptMenu1;
            $scope.def_entOthrBrsrIDVrsn1[b] =
              $scope.jsonData[0].Criteria[b].S_othrBrsVrsn;
            $scope.default_testResult1[b] =
              $scope.jsonData[0].Criteria[b].S_othrBrsType;
            ...
            if (
              $scope.jsonData[0].Criteria[b].S_edge === "Edge" ||
              $scope.jsonData[0].Criteria[b].S_edge === "  Edge  "
            ) {
            ...
            if (
              $scope.jsonData[0].Criteria[b].S_chrome === "Chrome" ||
              $scope.jsonData[0].Criteria[b].S_chrome === "  Chrome  "
            ) {
            ...
            if (
              $scope.jsonData[0].Criteria[b].S_safari === "Safari" ||
              $scope.jsonData[0].Criteria[b].S_safari === "  Safari  "
            ) {
            ...
            if (
              $scope.jsonData[0].Criteria[b].S_other === "Other Browser" ||
              $scope.jsonData[0].Criteria[b].S_other === "  Other Browser  "
            ) {
            ...
            if (
              $scope.jsonData[0].Criteria[b].S_firefox === "Firefox" ||
              $scope.jsonData[0].Criteria[b].S_firefox === "  Firefox  "
            ) {
            ...
            if ($scope.jsonData[0].Criteria[b].TestResult != undefined) {
              if ($scope.jsonData[0].Criteria[b].TestResult != "undefined") {
                $scope.default_SelectedResult[b] =
            ...
            if ($scope.jsonData[0].Criteria[b].TesterComment != "undefined") {
              $scope.testerCommentID[b] =
                $scope.jsonData[0].Criteria[b].TesterComment;
            }
            if ($scope.jsonData[0].Criteria[b].Counter != undefined) {
              $scope.counterCollection[b] =
                $scope.jsonData[0].Criteria[b].Counter;
            }
            if ($scope.jsonData[0].Criteria[b].Counter == undefined) {
              $scope.counterCollection[b] = "";
            }
            ...
            if ($scope.jsonData[0].Criteria[b].TestProcess != "undefined") {
              $scope.testProcessID[b] =
                $scope.jsonData[0].Criteria[b].TestProcess;
            }
            ...
            if (
              $scope.jsonData[0].Criteria[b].RemediationDetails == undefined
            ) {
	...
	*/
            ...
            if ($scope.jsonData[0].Criteria[b].ImageSrc2 != undefined) {
              if ($scope.jsonData[0].Criteria[b].ImageSrc2 != ".") {
                $scope.imgCnvrsnDefault2.push(
                  '{"imgPosition2" : "' + b + '"',
                  '"imgValue2" :"' +
                    $scope.jsonData[0].Criteria[b].ImageSrc2 +
                    '"}',
                );
          ...
          $scope.imgCnvrsnDefault = [];
          $scope.imgCnvrsn2 = $scope.imgCnvrsn2.concat(
            $scope.imgCnvrsnDefault2,
          );
          ...
          if ($scope.displayIt == false) {
            alert(
              "Please select the appropriate JSON file to  view complete page.",
            );
          }
          ...
          alert(
            "File loaded.To save changes at any time, use Alt+S or Save button at bottom of the page.",
          );
          if ($scope.default_tstVrsn == "undefined") {
          ...
          if ($scope.updateJSON == true) {
            alert(
              "An updated JSON template is available. However, you may continue to use your current template.",
            );
          }
    ...
    $scope.remediationDetails = function () {
      ...
      if ($scope.selected_name_rmdtn == "No") {
        if ($scope.displayIt == false) {
          alert(
            "Please select the approperiate JSON file to  add remediation details.",
          );
        }
        /* if ($scope.checkboxModel.alerts == "on")
    ...
    $scope.remarkExplanation = function (i) {
      if ($scope.selected_name_tstgrp[i] == undefined) {
        ...
        $scope.RemarkExplntn[i] = [
          '{"crtId": "' +
            $scope.criteriaTestsJson.Criteria[i].CrtID +
            '", "explanation":"' +
            "Test Result is not selected for this " +
            '"}',
        ];
        ...
        $scope.RemarkExplntn[i] = [
          '{"crtId": "' +
            $scope.criteriaTestsJson.Criteria[i].CrtID +
            '", "explanation":"' +
            "All Test Conditions Successfully PassESed " +
            '"}',
        ];
        $scope.RemarkExplntnCollection.push($scope.RemarkExplntn[i]);
        ...
        $scope.resultFailsCollection.push($scope.resultFails[i]);
        $scope.testerCommentID[i] = $scope.testerCommentID[i].replace(
          /"/g,
          "'",
        );
        $scope.RemarkExplntn[i] = [
      ...
      $scope.rmdatnDtlID[i] = " "; */
        ...
        $scope.RemarkExplntn[i] = [
          '{"crtId": "' +
            $scope.criteriaTestsJson.Criteria[i].CrtID +
            '", "explanation":"' +
            " One or more test conditions Not Tested " +
            '"}',
        ];
        $scope.RemarkExplntnCollection.push($scope.RemarkExplntn[i]);
        $scope.crtRsltCollection.push($scope.selected_name_tstgrp[i]);
    ...
    $scope.uploadImage = function (element) {
      ...
      reader.onloadend = function () {
        ...
        if (element != null) {
          ...
          $scope.imgCnvrsnCurrent.push(
            '{"imgPosition" : "' + imgPstn + '"',
            '"imgValue" :"' + reader.result + '"}',
          );
    ...
    $scope.uploadImage2 = function (element) {
      ...
      reader.onloadend = function () {
        ...
        if (element != null) {
          ...
          $scope.imgCnvrsnCurrent2.push(
            '{"imgPosition2" : "' + imgPstn + '"',
            '"imgValue2" :"' + reader.result + '"}',
          );
          $scope.imgCnvrsn2 = $scope.imgCnvrsn2.concat(
            $scope.imgCnvrsnCurrent2,
          );
    ...
    $scope.uploadImage1 = function (element) {
      ...
      reader.onloadend = function () {
        if (element != null) {
          let imgPstn = element.closest("tr").rowIndex;
          imgPstn = imgPstn - 1;
          const imgPos = imgPstn - $scope.origSelectedResults;
          ...
          $scope.imgCnvrsnCurrent1.push(
            '{"imgPosition" : "' + imgPstn + '"',
            '"imgValue" :"' + reader.result + '"}',
          );
          $scope.imgCnvrsn1 = $scope.imgCnvrsn1.concat(
            $scope.imgCnvrsnCurrent1,
          );
          $scope.imgCnvrsnCurrent1 = [];
          setTimeout(function () {
    ...
    $scope.elemntClicked2 = function (i) {
      ...
      setTimeout(function () {
        for (let b = 0; b < $scope.origSelectedResults; b++) {
          if (i == b) {
            if (
              $scope.jsonData[0].Criteria[b].TestID == " 1.A" &&
              $scope.selected_name_tstgrp[b] == "Does Not Apply"
            ) {
            ...
            if (
              $scope.jsonData[0].Criteria[b].TestID == "5.A" &&
              $scope.selected_name_tstgrp[b] == "Does Not Apply"
            ) {
              $scope.default_SelectedResult[b + 1] = "Does Not Apply";
              $scope.default_SelectedResult[b + 2] = "Does Not Apply";
            ...
            if (
              $scope.jsonData[0].Criteria[b].TestID == "10.A" &&
              $scope.selected_name_tstgrp[b] == "Does Not Apply"
            ) {
              $scope.default_SelectedResult[b + 1] = "Does Not Apply";
              $scope.default_SelectedResult[b + 2] = "Does Not Apply";
            ...
            if (
              $scope.jsonData[0].Criteria[b].TestID == "14.A" &&
              $scope.selected_name_tstgrp[b] == "Does Not Apply"
            ) {
              $scope.default_SelectedResult[b + 1] = "Does Not Apply";
              // $scope.default_SelectedResult[b+2] = "Does Not Apply";
            ...
            if (
              $scope.jsonData[0].Criteria[b].TestID == "17.A" &&
              $scope.selected_name_tstgrp[b] == "Does Not Apply"
            ) {
              $scope.default_SelectedResult[b + 1] = "Does Not Apply";
              // $scope.default_SelectedResult[b+2] = "Does Not Apply";
...
*/
   ...
   */
    ...
    $scope.browserTypeCollection1[i] = $scope.checkboxModel.value14[i] + "  " + $scope.checkboxModel.value51[i] + "   " + $scope.checkboxModel.value21[i] + "  " + $scope.checkboxModel.value31[i] + "  " + $scope.checkboxModel.value41[i] + "  " + $scope.otherBrowser1[i] + " " + $scope.entOthrBrsrIDl[i]; */
        ...
        $scope.testerCommentID[i] = $scope.testerCommentID[i]
          .toString()
          .replace(/"/g, "'");
        $scope.testerCommentID[i] = $scope.testerCommentID[i]
          .toString()
        ...
        $scope.criteriaTestsJson.Criteria[i].TestName =
          $scope.criteriaTestsJson.Criteria[i].TestName.toString().replace(
            /"/g,
            "'",
          );
        $scope.criteriaTestsJson.Criteria[i].TestName =
    ...
    if ($scope.selected_name_glbl[i] == 'undefined');
      $scope.selected_name_glbl[i] = " "; */
        ...
        if ($scope.edit == true) {
          ...
          if ($scope.selected_name_tstgrp[i] == "Fail") {
            const fpcMapping =
              ...
              '",' +
              '"DisabilityImpact": "' +
              $scope.criteriaTestsJson.Criteria[i].DisabilityImpact +
              '",' +
              '"TestName": "' +
              $scope.criteriaTestsJson.Criteria[i].TestName +
              '","TesterComment": "' +
        ...
        if ($scope.criteriaTestsJson.Criteria[i].ExpectedResult == "dna") {
          $scope.criteriaTestsJson.Criteria[i].ExpectedResult =
            "does not apply";
        }
        ...
        if (
          $scope.selected_name_tstgrp[i].toLowerCase() ==
          $scope.criteriaTestsJson.Criteria[i].ExpectedResult.toLowerCase()
        ) {
          $scope.Aligned[i] = "Yes";
        } else {
          $scope.Aligned[i] = "No";
        ...
        $scope.testProcessID[i] = $scope.testProcessID[i]
          .toString()
          .replace(/"/g, "'");
        $scope.testProcessID[i] = $scope.testProcessID[i]
          .toString()
        ...
        $scope.testresult[i] =
          ...
          '",' +
          '"TestID": "' +
          $scope.criteriaTestsJson.Criteria[i].TestID +
          '",' +
          '"TestCaseURL": "' +
          $scope.criteriaTestsJson.Criteria[i].TestCaseURL +
          '",' +
          '"TestName": "' +
          $scope.criteriaTestsJson.Criteria[i].TestName +
          '",' +
          ...
          '",' +
          '"TestFile": "' +
          $scope.criteriaTestsJson.Criteria[i].TestFile +
          '",' +
          '"TestFileURL": "' +
          $scope.criteriaTestsJson.Criteria[i].TestFileURL +
          '",' +
          '"Aligned": "' +
          $scope.Aligned[i] +
          '",' +
          '"Counter": "' +
          $scope.counterCollection[i];
        ...
        for (let m = 0; m < $scope.imgCnvrsnJSON.length; m++) {
          if (i == $scope.imgCnvrsnJSON[m].imgPosition) {
            ...
            $scope.testresult[i] =
              $scope.testresult[i] +
              '","ImageSrc":"' +
              $scope.imgCnvrsnJSON[m].imgValue;
          }
        }
        // }
        ...
        for (let n = 0; n < $scope.imgCnvrsnJSON2.length; n++) {
          if (i == $scope.imgCnvrsnJSON2[n].imgPosition2) {
            ...
            $scope.testresult[i] =
              $scope.testresult[i] +
              '","ImageSrc2":"' +
              $scope.imgCnvrsnJSON2[n].imgValue2;
          }
        }
        // }
      ...
      for (let k = 0; k < $scope.indexCollection.length; k++) {
        ...
        $scope.browserIndividualVersionsCollection11[k] =
          '","S_ieVrsh": "' +
          $scope.selected_name_ieVersn11[k] +
          '","S_edgeVrsn": "' +
          $scope.selected_name_edVersn11[k] +
          ...
          '","S_othrBrsVrsn": "' +
          $scope.entOthrBrsrID11[k];
        $scope.browserIndividualTypeCollection11[k] =
          '","S_ie": "' +
          $scope.checkboxModel.value141[k] +
          '","S_edge": "' +
          $scope.checkboxModel.value511[k] +
        ...
        $scope.browserVersionsCollection11[k] =
          $scope.selected_name_ieVersn11[k] +
          " " +
          $scope.selected_name_edVersn11[k] +
          " " +
        ...
        $scope.testerCommentID1[k] = $scope.testerCommentID1[k]
          .toString()
          .replace(/"/g, "'")
          .trim();
        $scope.testerCommentID1[k] = $scope.testerCommentID1[k]
        ...
        $scope.location1[k] = $scope.location1[k]
          .toString()
          .replace(/"/g, "'")
          .trim();
        $scope.location1[k] = $scope.location1[k]
        ...
        if ($scope.selected_name_tstgrp1[k] == "Pass") {
          ...
          $scope.RemarkExplntn[k] = [
            '{"crtId": "' +
              $scope.criteriaTestsJson.Criteria[i].CrtID +
              '", "explanation":"' +
              "For " +
              "All Test Conditions Successfully Passed " +
              '"}',
          ];
          ...
          $scope.resultFailsCollection.push($scope.resultFails[k]);
          $scope.testerCommentID[k] = $scope.testerCommentID[k].replace(
            /"/g,
            "'",
          );
          $scope.RemarkExplntn[k] = [
        ...
        if ($scope.rmdatnDtlID1[k] == "undefined") $scope.rmdatnDtlID1[k] = "";
        $scope.rmdatnDtlID1[k] = $scope.rmdatnDtlID1[k]
          .toString()
          .replace(/"/g, "'")
          .trim();
        $scope.rmdatnDtlID1[k] = $scope.rmdatnDtlID1[k]
        ...
        for (let p = 0; p < $scope.imgCnvrsnJSON1.length; p++) {
          if ($scope.counter == $scope.imgCnvrsnJSON1[p].imgPosition) {
            $scope.testresult2[k] = $scope.testresult2[k].substring(
              0,
              $scope.testresult2[k].length - 1,
            );
            // $scope.testresult2[k] = $scope.testresult2[k] +$scope.imgCnvrsnJSON1[p].imgValue+'"}';
            $scope.testresult2[k] =
              $scope.testresult2[k] + $scope.imgCnvrsnJSON1[p].imgValue;
          }
        }
	 ...
	 */
        ...
        if ($scope.selected_name_tstgrp1[k] == undefined) {
          ...
          $scope.RemarkExplntn[k] = [
            '{"crtId": "' +
              $scope.criteriaTestsJson.Criteria[k].CrtID +
              '", "explanation":"' +
              "Test Result is not selected for this " +
              '"}',
          ];
      ...
      $scope.successCriteriaFxn = function () {
        ...
        const c = $scope.indexCollection.length - 1;
        for (let a = 0; a < $scope.totTstRsltJson.length; a++) {
          if ($scope.totTstRsltJson[a].TestResult != undefined) {
            if (a > 0) {
              if (
                $scope.totTstRsltJson[a].CrtID !=
                $scope.totTstRsltJson[a - 1].CrtID
              ) {
                $scope.FailSelected = false;
                $scope.PassSelected = false;
                $scope.dnaSelected = false;
            ...
            if ($scope.totTstRsltJson[a].TestResult == "Fail") {
              ...
              if ($scope.indexCollection.length > 0) {
                for (b = 0; b < $scope.indexCollection.length; b++) {
                  if (
                    $scope.Mul_Issues3[b].InsrtTestID ==
                    $scope.totTstRsltJson[a].TestID
                  ) {
                    $scope.dsbl_Impctd_grp[a] =
                      $scope.Mul_Issues3[b].InsrtDisabilityImpact;
                    $scope.guideline[a] = $scope.Mul_Issues3[b].InsrtGuideline;
                  }
                }
              } else {
                $scope.dsbl_Impctd_grp[a] =
                  $scope.totTstRsltJson[a].DisabilityImpact;
                  ...
                  for (b = 0; b < $scope.indexCollection.length; b++) {
                    if (
                      ...
                      $scope.dsbl_Impctd_grp[a] =
                        $scope.Mul_Issues3[b].InsrtDisabilityImpact;
                      $scope.guideline[a] =
                        $scope.Mul_Issues3[b].InsrtGuideline;
                    }
                  }
                } else {
                  $scope.dsbl_Impctd_grp[a] =
            ...
            if ($scope.dsbl_Impctd_grp[a] != "") {
              ...
              $scope.criteriaResult.push(
                '{"CrtID": "' +
                  ...
                  $scope.dsbl_Impctd_grp[a] +
                  '","RemarkExplntn": "' +
                  $scope.totTstRsltJson[a].TestName +
                  ". " +
                  $scope.totTstRsltJson[a].TesterComment +
                  '"}',
              );
            }
          ...
          for (let q = $scope.criteriaResultJSON.length; q > 0; q--) {
            if ($scope.criteriaResultJSON[q] != undefined) {
              if ($scope.criteriaResultJSON[q] != "undefined") {
                if (q != 0) {
                  if (
                    $scope.criteriaResultJSON[q].CrtID !=
                    $scope.criteriaResultJSON[q - 1].CrtID
                  ) {
                  ...
                  if (
                    $scope.criteriaResultJSON[q].CrtID ==
                    $scope.criteriaResultJSON[p].CrtID
                  ) {
                    if (
                      $scope.criteriaResultJSON[q - 1].ConformanceLvl ==
                      "Does Not Support"
                    ) {
                      $scope.conformanceLevel = "Does Not Support";
                    } else if (
                      $scope.criteriaResultJSON[q].ConformanceLvl == "Supports"
                    ) {
                      if (
                        $scope.criteriaResultJSON[q - 1].ConformanceLvl ==
                        "Does Not Support"
                      ...
                      $scope.criteriaResultJSON[q].ConformanceLvl ==
                      "Not Evaluated"
                    ) {
                      if (
                        $scope.criteriaResultJSON[q - 1].ConformanceLvl ==
                ...
                if (
                  ...
                  $scope.criteriaResultJSON[q].ConformanceLvl ==
                    "Does Not Support" &&
                  $scope.criteriaResultJSON[p].ConformanceLvl == "Supports"
                ) {
                  $scope.conformanceLevel = "Does Not Support";
                } else if (
                  $scope.criteriaResultJSON[q].ConformanceLvl ==
                    "Does Not Support" &&
                  $scope.criteriaResultJSON[p].ConformanceLvl ==
                    "Not Applicable"
                ) {
                  $scope.conformanceLevel = "Does Not Support";
                } else if (
                  $scope.criteriaResultJSON[q].ConformanceLvl ==
                    "Does Not Support" &&
                  $scope.criteriaResultJSON[p].ConformanceLvl == "Not Evaluated"
                ) {
                  $scope.conformanceLevel = "Does Not Support";
                } else if (
                  $scope.criteriaResultJSON[q].ConformanceLvl ==
                ...
                if (
                  ...
                  $scope.scValueUniqueSelected =
                    ...
                    $scope.criteriaResultJSON[q].ConformanceLvl +
                    '","DisabilityImpact": "' +
                    $scope.criteriaResultJSON[q].DisabilityImpact +
                    '","RemarkExplntn": "' +
                    $scope.criteriaResultJSON[q].RemarkExplntn +
                    '"}';
                } else if (
                  $scope.criteriaResultJSON[q].ConformanceLvl == "Supports"
                ) {
                  ...
                  $scope.criteriaResultJSON[q].ConformanceLvl == "Not Evaluated"
                ) {
        ...
        $scope.criteriaResult2 = $scope.criteriaResult2.filter(
          $scope.onlyUnique,
        );
        // $scope.criteriaResult1 = '"SuccessCriteria": [' + $scope.criteriaResult2 + ']';

        $scope.criteriaResult1 =
          '"SuccessCriteria": [' + $scope.criteriaResult + "]";
      };
      $scope.successCriteriaFxn();
      $scope.osVrsnNo = " ";
      ...
      $scope.osVrsnNo =
        ...
        $scope.chkBoxValOthrWndw1 +
        '","S_otherOSVrsn": "' +
        $scope.entOthrWindVrsn +
        '","S_otherOSType": "' +
        $scope.entOthrWindID;
      $scope.osCollection = [];
      if (
        $scope.checkboxModel.value6 != undefined ||
        $scope.checkboxModel.value6 != ""
      ) {
        $scope.osCollection.push($scope.checkboxModel.value6);
      }
      if (
        $scope.checkboxModel.value7 != undefined ||
        $scope.checkboxModel.value7 != ""
      ) {
        $scope.osCollection.push($scope.checkboxModel.value7);
      }
      if (
        $scope.checkboxModel.value8 != undefined ||
        $scope.checkboxModel.value8 != ""
      ) {
      ...
      if (
        $scope.selected_name_wnVersn != undefined ||
        $scope.selected_name_wnVersn != ""
      ) {
        $scope.osVrsnCollection.push($scope.selected_name_wnVersn);
      }
      if (
        $scope.selected_name_iosVersn != undefined ||
        $scope.selected_name_iosVersn != ""
      ) {
      ...
      if (
        $scope.checkboxModel.value1 != undefined ||
      ...
      $scope.prodDescID = $scope.prodDescID
        .toString()
        .replace(/"/g, "'")
        .trim();
      $scope.prodDescID = $scope.prodDescID.toString().replace(/\n/g, " ");
      $scope.prdNteDescID = $scope.prdNteDescID
        .toString()
        .replace(/"/g, "'")
        .trim();
      ...
      $scope.testerContact = $scope.testerContact
        .toString()
        .replace(/"/g, "'")
        .trim();
      $scope.testerContact = $scope.testerContact
    ...
    $scope.osVrsnCollection = $scope.osVrsnCollection.push($scope.entOthrWindVrsn); */
      $scope.browserVrsnCollection = $scope.browserVrsnCollection
        .toString()
        .replace(/, /g, "")
        .trim();
      $scope.browserVrsnCollection = $scope.browserVrsnCollection
        ...
        .replace(/,/g, ", ")
        .trim();
      $scope.osVrsnCollection = $scope.osVrsnCollection
        .toString()
        .replace(/, /g, " ")
        .trim();
      $scope.osVrsnCollection = $scope.osVrsnCollection
        ...
        .replace(/,/g, ", ")
        .trim();
      $scope.osCollection = $scope.osCollection
        .toString()
        .replace(/, /g, " ")
        .trim();
      $scope.osCollection = $scope.osCollection
        ...
        .replace(/,/g, ", ")
        .trim();
      $scope.browserCollection = $scope.browserCollection
        .toString()
        .replace(/, /g, " ")
        .trim();
      $scope.browserCollection = $scope.browserCollection
    ...
    $scope.submit1 = function () {
      ...
      if ($scope.companyname == " " || $scope.companyname == undefined) {
        $scope.error.push(
          "Testing Information: Company Name in Testing Information Section",
        );
      }
...
*/
        ...
        if ($scope.sbmtClicked != 1) {
          ...
          $scope.submitMessage =
            "File saved  " + $scope.sbmtClicked + " times in current session.";
        }
        ...
        const blob = new Blob([$scope.formData], {
 	...
 	if ($scope.checkboxModel.alerts == "on")
      ...
      $scope.criteriaResult = $scope.criteriaResult.concat(
        $scope.criteriaResult,
      );
      $scope.criteriaResult2 = $scope.criteriaResult2.push(
        $scope.criteriaResult2,
      );
